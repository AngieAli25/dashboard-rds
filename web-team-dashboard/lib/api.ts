...
export const dashboardApi = {
  ...
  getTeamWorkload: (): Promise<TeamWorkload[]> =>
    api.get('/dashboard/team-workload/').then(res => res.data),
};
...
export const clientsApi = {
  ...
  getStats: (): Promise<DashboardStats> =>
    api.get('/clients/stats/').then(res => res.data),
  
  bulkUpdate: (updates: Array<{ id: number; [key: string]: any }>): Promise<{ updated: Client[] }> =>
    api.post('/clients/bulk_update/', { updates }).then(res => res.data),
};

// Team Members APIs
export const teamApi = {
  getAll: (): Promise<TeamMember[]> =>
    api.get('/team-members/').then(res => res.data.results || res.data),
...
export const snapshotsApi = {
  ...
  createCurrent: (): Promise<MonthlySnapshot> =>
    api.post('/snapshots/create_current/').then(res => res.data),
};
